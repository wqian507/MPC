...
$ python3 launcher.py \
    --evaluate \
    --resume \
    --model-location model_best.pth.tar \
    --batch-size 1 \
    --print-freq 1 \
    --skip-plaintext \
    --multiprocess
...
parser.add_argument('--net', default='LeNet', type=str, help='model architecture')
parser.add_argument('--project', default='crypten', type=str, help='project name')
parser.add_argument(
    "--world_size",
    type=int,
    default=2,
...
def _run_experiment(args):
    ...
    if not torch.cuda.is_available():
        logging.info("GPU is not avaiable!")
